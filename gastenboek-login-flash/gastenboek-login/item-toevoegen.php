...
if ($_POST) {
    ...
    if (empty($foutmeldingen)) {
        $query = $pdo->prepare('INSERT INTO gastenboek (user_id, beschrijving, hotel_id, score) VALUES (:user_id, :beschrijving, :hotel_id, :score)');
        $query->execute([
            'user_id' => $user['id'],
        ...
        $_SESSION['alert'] = 'Nieuw item toegevoegd';

...
$query = $pdo->query('SELECT gastenboek.*, users.username AS naam, hotels.id AS hotel_id, hotels.naam AS hotel_naam FROM GASTENBOEK INNER JOIN users ON gastenboek.user_id=users.id INNER JOIN hotels ON gastenboek.hotel_id=hotels.id');
